...
- [Options](#-options)
- [Examples](#-examples)
- [Refresh Screenshots](#-refresh-screenshots)
...
The screenshots in `.docs/` are generated by the local refresh script.

```bash
./.docs/update_screenshots.sh
```

This rebuilds the SVG assets used in the README with a consistent terminal layout, no window buttons, and a GitHub-friendly width.
