...
# Build small demo fixtures with visible strings, zeros, and known headers.
...
capture "search.svg" "hxed -se ascii:secret sample.bin" "$BIN" -se "ascii:secret" "$TMP_DIR/sample.bin"
