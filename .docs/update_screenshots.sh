...
capture "heat.svg"   "hxed -hm adaptiv random.bin" "$BIN" -hm adaptiv "$TMP_DIR/random.bin"
capture "search.svg" "hxed -sa 'secret' sample.bin" "$BIN" -sa "secret" "$TMP_DIR/sample.bin"
